RSpec.describe Api::V1::ArticlesController, type: :request do
  describe ' GET /article/1 successfully' do
    let!(:article) { create(:article, :with_image, title: 'NOSPACE', snippet: 'You thought you liked space', content: 'NOSPACE is where you want to be') }

    before do  
      get "/api/v1/articles/#{Article.last.id}"
    end
